...
export const DuplicateChecker: React.FC<DuplicateCheckerProps> = ({
  ...
  return (
    <div className="bg-amber-50 border border-amber-200/80 rounded-2xl p-5 text-slate-700 mt-4 shadow-sm">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-3.5 mt-4 flex items-start gap-4 shadow-inner">
      ...
      <div className="grid grid-cols-2 gap-3 mt-4">
        <button
          ...
          className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-3 rounded-xl text-xs transition-colors shadow-sm cursor-pointer"
        >
