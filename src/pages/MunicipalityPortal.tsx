...
export const MunicipalityPortal: React.FC<{ activeView: string }> = () => {
  return (
    <div className="glass-panel p-6">
      <h2 className="text-base font-bold text-slate-800">Municipality Governance Portal (Deprecated)</h2>
